...
namespace TestingReqnroll.Reportes.StepDefinitions
{
    [Binding]
    public class InsertStepDefinitions
    {
        ...
        public void WhenRegistroDeUsuarioEnLaBaseDeDatos()
        {
            try
            {
        ...
        public void ThenElResultadoDelRegistroEnLaBaseDeDatos(DataTable dataTable)
        {
            try
            {
                var clienteData = dataTable.Rows[0];
                ...
                Assert.Equal(clienteData["FechaNacimiento"], clienteDb.FechaNacimiento.ToString("dd/MM/yyyy"));
